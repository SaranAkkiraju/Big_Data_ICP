...
def main(_):
  ...
  # We've completed all our training, so run a final validation evaluation on
  ...
  print('Final validation accuracy = %.1f%% (N=%d)' % (
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default=-1,
      help="""\
      How many images to validation on. This validation set is only used once, to evaluate
      the final accuracy of the model after training completes.
      A value of -1 causes the entire validation set to be used, which leads to more
  ...
  parser.add_argument(
      ...
      used much more often than the validation set, and is an early indicator of how
  ...
  parser.add_argument(
      ...
      default=False,
      help="""\
      Whether to print out a list of all misclassified validation images.\
      """,
      action='store_true'
  )
  parser.add_argument(
