...
def read_NewsGroup_data(similarity):    
    categories_5NG = ['comp.graphics', 'rec.sport.baseball', 'talk.politics.guns','rec.autos','sci.space']
    dataset = fetch_20newsgroups(subset='train', categories=categories_5NG,
